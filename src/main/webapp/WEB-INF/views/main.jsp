...
<div style="text-align: center;">
    <div id='title'> WISH TICKET</div>
    <img class="passport" src = "/images/main_passport_1.png" alt="없음" width="400px" >
    <div id='content'>우리 같이 떠나자!</div>
    <div id="kakao">
        <span id="kakao_msg">
            <a href="/kakao" class="kakao_href">
            <img src="/images/kakao.png" width="50px" class="kakao_img">
            <span class="msg">카카오로 여권 만들기</span>
            </a>
        </span>
    </div>
    <div id="naver">
        <a href="/naver" class="naver_href">
            <img src="/images/naver.png" width="50px" class="naver_img">
            <span class="msg" id="naver_msg">네이버로 여권 만들기</span>
        </a>
    </div>
    <div id="google">
        <a href="/google" class="google_href">
            <img src="/images/google.png" width="50px" class="google_img">
            <span class="msg" id="google_msg">구글로 여권 만들기</span>
        </a>
    </div>
</div>

<!-- 별똥멸 애니메이션 효과 div class="c1_s"중 위에 것은 상단부, 아럐것은 하단부)-->
<!-- 좌표 수정 필요 : 현재는 넓게 랜덤 발생이라 웹페이지 사이즈가 자꾸 변함 ㅠㅠ-->
<div id="early2021">
    <div class="top">
        <div class="inner">
            <div class="c1_s">
