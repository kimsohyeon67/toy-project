...
<body>
    ...
    <div style="text-align: center;">
        ...
        <div class="btn" id="kakao">
            <a href="/auth/kakao" class="href">
                <img src="/images/kakao.png" width="45px">
                <span class="msg">카카오로 여권 만들기</span>
            </a>
        </div>
        <div class="btn" id="naver">
            <a href="/auth/naver" class="href">
                <img src="/images/naver.png" width="45px">
                <span class="msg">네이버로 여권 만들기</span>
            </a>
        </div>
        <div class="btn" id="google">
            <a href="/auth/google" class="href">
                <img src="/images/google.png" width="45px">
                <span class="msg">구글로 여권 만들기</span>
            </a>
        </div>
    </div>
