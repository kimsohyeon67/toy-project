...
<div style="text-align: center;">
    ...
    <div id="ticket_list">
        <button type="button" class="btn" id="img_btn1"><img src="/images/ticket/01_00.jpg" width="100px"></button>
        <button type="button" class="btn" id="img_btn2"><img src="/images/ticket/02_00.jpg" width="100px"></button>
        <button type="button" class="btn" id="img_btn3"><img src="/images/ticket/03_00.jpg" width="100px"></button>
        <button type="button" class="btn" id="img_btn4"><img src="/images/ticket/04_00.jpg" width="100px"></button>
    </div>
</div>
