...
<%passport_dto = (Passport)request.getAttribute("passport_dto");%>
	...
	<div class="title">나만의 여권을 수정해 보세요!</div>
	<!-- 1. 여권 색상과 아이콘 고르기 -->
	<div class="step1">
		<div id="cover-view">
	...
	<div class="step2">
		...
		<div id="user-info" class="flex-col-box">
			...
			<div id="face-box">
				<div id="face-info">
					<img src=<%=path + "/face/body" + passport_dto.getHair() + ".png"%> id="body-img">
		    		<img src=<%=path + "/face/face" + passport_dto.getFace() + ".png"%> id="face-img">
				</div>
				<p>여권 사진 찍기</p>
			</div>
			...
			<input type="hidden" name="passport_num" id="hidden_passport_num" value=${passport_dto.passport_num}>
			</div>
			</div>
		<div class="next-btn">
			<input type="submit" value="여권 재발급">
		</div>
		</div>
			</form>
	</div>
